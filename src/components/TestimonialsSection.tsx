...
const testimonials = [
  ...
  {
    quote: "As an education researcher, the sessions on assessment design, psychometrics, and evaluation methods were immediately useful. The certificate and Crossref DOI gave my abstract real academic weight.",
    name: "S. Kowalski",
