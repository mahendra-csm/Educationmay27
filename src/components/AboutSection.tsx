      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-500 text-base max-w-2xl mx-auto">
            Where educational excellence meets rigorous assessment and measurement innovation
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-5 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-gray-600 text-[15px] leading-relaxed mb-5">
              {conference.shortName} explores the critical intersection of{" "}
              <span className="text-[#1A56DB] font-semibold">educational assessment</span>,{" "}
              <span className="text-[#059669] font-semibold">evaluation methodologies</span>, and{" "}
              <span className="text-[#D97706] font-semibold">measurement techniques</span> from standardized testing and formative assessment to psychometric properties, data analysis, and innovative evaluation tools.
            </p>
            <p className="text-gray-600 text-[15px] leading-relaxed mb-6">
              The event brings together educators, researchers, assessment specialists, policymakers, administrators, and students in a dynamic online format featuring presentations, panel discussions, and live Q&A sessions focused on advancing educational measurement and evaluation practices.
            </p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-3xl border border-blue-100 p-6">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Indexing in Google Scholar and 10+ educational directories",
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { icon: Users, text: "Open to All", sub: "Educators, researchers, and assessment specialists", color: "#D97706" },
                ].map((detail, index) => (
