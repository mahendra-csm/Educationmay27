...
const benefits: BenefitItem[] = [
  ...
  },
  {
    ...
    detail: "All registered participants gain complimentary access to MetaSpectra's repository of over 170 million scholarly metadata records spanning assessment design, educational measurement, psychometrics, learning analytics, equity, and evaluning analytics, equity, and evaluation policy research.",
  },
  {
    icon: Mic,
