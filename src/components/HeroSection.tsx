...
const HERO_BG = "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=3840&q=95";
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center py-16 md:py-24">
        ...
        >
          <span className="text-[11px] md:text-xs font-medium tracking-wide text-white/80">
            ONLINE INTERNATIONAL CONFERENCE | EDUCATIONAL ASSESSMENT | MEASUREMENT & EVALUATION
          </span>
        </motion.div>
        ...
        >
          Present breakthrough work in <span className="text-white font-semibold">educational assessment</span>,{" "}
          <span className="text-white font-semibold">evaluation methodologies</span>,{" "}
          <span className="text-white font-semibold">measurement techniques</span>, and{" "}
          <span className="text-white font-semibold">educational research</span> while earning a{" "}
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <p className="text-white/70 text-xs uppercase tracking-widest mb-2 font-medium">Conference begins in</p>
          <CountdownTimer />
        </motion.div>
