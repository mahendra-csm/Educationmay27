      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        >
          ...
          <p className="mt-4 text-gray-500 max-w-3xl mx-auto">
            IC-AEEM 2026 invites interdisciplinary abstract submissions on educational assessment, evaluation methodologies, measurement techniques, and innovative educational research practices.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img
                src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=1920&q=90&fit=crop"
                alt="Educational assessment and research presentation"
