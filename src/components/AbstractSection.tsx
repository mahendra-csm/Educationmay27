...
const AbstractSection = () => {
  ...
  return (
    <section className="relative overflow-hidden py-16 md:py-24 px-4 md:px-8" ref={ref}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-5 text-white leading-tight">
            Why Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-400">IC-AEEM 2026</span> Abstract Matters
          </h2>
